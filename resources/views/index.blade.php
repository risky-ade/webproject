	...
	<body>
		...
		<div class="navbar-inner navigasiatas">
			<div class="container">
		<a class="brand" href="#"><span class="icon-home"></span></a>
			...
			<div class="nav-collapse collapse">
				<ul class="nav">
			<li><h5>Senin, 24 Oktober 2012</h5></li>
				</ul>
		<div class="sosial">
						...
						<a href="http://memoarema.com"><img src="img/imagesite/icon/feed.png" /></a>
		</div>
		...
		<div class="container userid">
			<div class="row">
				<div class="span5">
					<img src="img/imagesite/Mobile-icon.png" style="float:left;width: 20px;height: 20px;margin-top: 12px;" /><h6 style="margin-left:10px;"><a href="">Mobile Version</a><a href="">Kontak Redaksi</a><a href="">Sitemap</a></h6>
				</div>
		...
		<div class="container isi-situs">
			<div class="row">
				<div class="span4">
					<img class="logo" src="img/imagesite/logo.png" />	
				</div>
				<div class="span8">
					<img src="img/imagesite/iklan.jpg" />
				</div>
		</div>
			<div class="row">
				<div class="span12">				
				...
				<!-- navigasi bar -->
					...
					<div class="navbar-inner navigasibar">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu menudrop" role="menu" aria-labelledby="drop2">
							<li><a tabindex="-1" href="#">Malang</a></li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu menudrop" role="menu" aria-labelledby="drop2">
							<li><a tabindex="-1" href="#">Arema</a></li>
							<li><a tabindex="-1" href="#">Persema</a></li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu menudrop" role="menu" aria-labelledby="drop2">
							<li><a tabindex="-1" href="#">Peta Malang</a></li>
							<li><a tabindex="-1" href="#">Jalur Angkot Malang</a></li>
							<li><a tabindex="-1" href="#">Jadwal Kereta dan Pesawat</a></li>
							<li><a tabindex="-1" href="#">Info Hotel</a></li>
							<li><a tabindex="-1" href="#">Rekreasi Malang</a></li>
							<li><a tabindex="-1" href="#">Sejarah Malang</a></li>
							<li><a tabindex="-1" href="#">Kuliner Malang</a></li>
							<li><a tabindex="-1" href="#">Budaya Malang</a></li>
							<li><a tabindex="-1" href="#">Osob Ngalam</a></li>
				...
				<!-- navigasi bar -->
				<!--navigasi 2-->
					<div class="navigasibar2">
						<a href="">Mobile Site</a>
						<a href="">Citizen Jurnalisme</a>
						<a href="">Iklan Baris</a>
						<a href="">Berita Tepat</a>
						<a href="">Event Malang</a>
				...
				<div class="row">
					...
					<div class="span5">
						...
						<!-- konten iklan2 -->
							<div class="span4 iklan2">
									<img src="img/imagesite/iklan2.jpg"/>
									<div id="test"></div>
							</div>
							<!-- konten iklan2 -->
				</div>
				...
				<div class="row isipilihan">
					...
					<div class="span3">
						...
						<ul class="nav nav-tabs nav-mostview" id="myTab">
							<li class="active"><a href="#tab1" data-toggle="tab">Most Popular</a></li>
							<li><a href="#tab2" data-toggle="tab">Most Commented</a></li>
						</ul>
						...
						<div class="iklan3">
							<img src="img/imagesite/iklankiri.jpg" />
						</div>

						<!-- berita tepat-->
						<div class="isi-tepat">
										<h5 class="judul">Berita Tepat&nbsp;<span class="icon-time"></span></h5>
										<table>
											<tr>
												<td>
													<select name="tanggal">
														<option value="" selected="selected">-Pilih Tanggal-</option>
												...
												<td align="center">
													...
													<button class="btn btn-success button"><span class="icon-eye-open icon-white"></span>&nbsp;Tampilkan</button>
												</td>
												</tr>
												</table>					
									</div>
						...
						<div class="kolom-aspirasi">
							<h5 class="judul-aspirasi">Aspirasi Masyarakat</h5>
							<div class="isi-aspirasi">
								<div id="content">
									<div id="info" class="block">
										<ul id="tickerz">
												<li>
													<b>Titolo Lorem Ipsum 3</b>
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec suscipit, ante id porttitor faucibus, odio 
													eros pellentesque sapien, at consectetur mi nibh at massa.</p>
												</li>
												<li>
													<b>Titolo Lorem Ipsum 3</b>
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec suscipit, ante id porttitor faucibus, odio 
										...
										<center>
										<div class="btn-group">
													<button class="btn btn-small btn-link">Kirim Aspirasi</button>
													<button class="btn btn-small btn-link">Lihat Semua</button>
										</div>
										</center>
									</div>
								</div>
					...
					<div class="span5">
						...
						<div class="konten-terbaru">
							<div class="isi-terbaru">
								<span class="date">Sabtu, 17/11/2012 14:41 WIB</span>
								<h4 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h4>
								<img class="img-polaroid" src="img/imagesite/post/p1.png" />
								<p>Memo – Pelatih Arema, Rahmad Darmawan tampaknya harus kembali bersabar untuk menunggu pemainnya komplit. Pasalnya kedatangan dua pemain Victor Igbonefo dan Greg Nwokolo kembali harus tertunda.</p>
					...
					<div class="span4">
						...
						<div class="iklan3">
							<img src="img/imagesite/iklankanan.jpg" />
						</div>
						
						<div class="galeria">
							<h5 class="judul">Galeri Foto <span class="icon-camera"></span></h5>
							<div class="content">
								<!-- slider -->
								...
								<div id='coin-slider'>
									...
									<img src='img/imagesite/slide/filippocasale-master-multimedia.jpg' >
									<span>
				...
				<div class="row">
					<div class="span12">
						<img src="img/imagesite/iklan-bwh.jpg" width="100%" height="100%" />
					</div>
				</div>
				<!-- konten iklan3 -->
				...
				<div class="row">
					<div class="span4">
						<div class="content-news">
							<h5 class="judul"><span class="icon-th-list"></span> Hukum dan Peristiwa</h5>
							<div class="content">
								<div class="isi-berita">
									<img class="img-polaroid" src="img/imagesite/post/p1.png" />
									<h6 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h5>
									<small><em>18/10/2012 - 08:30</em></small>
								</div>
								<div class="isi-berita">
									<img class="img-polaroid" src="img/imagesite/post/p1.png" />
									<h6 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h5>
								...
								<a href="#" class="lengkap btn btn-link">&laquo; Berita Lainnya</a>
							</div>
						</div>
						...
						<div class="polling">
								...
								<div class="polling-terbaru">
									<h4>Bagaimana Pelayanan Angkutan Kota di Kota Malang?</h4>
									<input type="radio" name="polling1" value="bagus" checked="checked" />Memuaskan<br />
									<input type="radio" name="polling1" value="bagus" />Belum Memadai<br />
									<input type="radio" name="polling1" value="bagus" />Kurang Fasilitas<br />
									<input type="radio" name="polling1" value="bagus" />Bagus<br />
									<center><input class="btn btn-info" type="submit" name="polling1" value="Vote" />     <a href="">Hasil</a><br /></center>
								</div>
								<a href="">Polling lainnya</a>
						</div>
						

						<div class="content-news">
							<h5 class="judul"><span class="icon-th-list"></span> Nasional dan Internasional</h5>
							<div class="content">
								<div class="isi-berita">
									<img class="img-polaroid" src="img/imagesite/post/p1.png" />
									<h6 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h5>
						...
						<div class="evento">
							<h5 class="judul">
								<span class="icon-bookmark icon-white"></span> Event di Malang
							</h5>
							<div class="content">
								<img class="img-polaroid" src="img/imagesite/post/p1.png" />
								<h6><a href="">Seminar Teknologi Masa Depan</a></h6>
								<p>19 Oktober 2012 - Kampus UM</p>
								<p>oleh Panitia ICT</p>
							</div>
							<div class="content">
								<img class="img-polaroid" src="img/imagesite/post/p1.png" />
								<h6><a href="">Seminar Teknologi Masa Depan</a></h6>
							...
							<div class="foot">
								<center>
											<button class="btn btn-mini">Lihat Semua</button>
								</div>
								</center>
							</div>
					...
					<div class="span4">
						...
						<div class="content-news">
							<h5 class="judul"><span class="icon-th-list"></span> Infotainment</h5>
							<div class="content">
								<div class="isi-berita">
									<img class="img-polaroid" src="img/imagesite/post/p1.png" />
									<h6 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h5>
						...
						<div class="content-news">
							<h5 class="judul"><span class="icon-th-list"></span> Arema</h5>
							<div class="content">
								<div class="isi-berita">
									<img class="img-polaroid" src="img/imagesite/post/p1.png" />
									<h6 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h5>
						...
						<div class="content-news">
							<h5 class="judul"><span class="icon-th-list"></span> Persema</h5>
							<div class="content">
								<div class="isi-berita">
									<img class="img-polaroid" src="img/imagesite/post/p1.png" />
									<h6 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h5>
						...
						<div class="content-news">
							<h5 class="judul"><span class="icon-th-list"></span> Ragam</h5>
							<div class="content">
								<div class="isi-berita">
									<img class="img-polaroid" src="img/imagesite/post/p1.png" />
									<h6 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h5>
					...
					<div class="span4">
						...
						<div class="content-news">
							<h5 class="judul"><span class="icon-th-list"></span> Politik dan Pelayanan Publik</h5>
							<div class="content">
								<div class="isi-berita">
									<img class="img-polaroid" src="img/imagesite/post/p1.png" />
									<h6 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h5>
						...
						<div class="lowker">
							<h5 class="judul">Lowongan Kerja</h5>
							<div class="content">
								<h6>Staff Keuangan</h6>
								<p>oleh PT. Sejahtera Sentosa</p>
							</div>
							<div class="content">
								<h6>Staff Keuangan</h6>
								<p>oleh PT. Sejahtera Sentosa</p>
							...
							<div class="foot">
								<center>
								<div class="btn-group">
											<button class="btn btn-mini btn-warning">Pasang Lowongan</button>
											<button class="btn btn-mini">Lihat Semua</button>
								</div>
								</center>
							</div>
						...
						<div class="content-news">
							<h5 class="judul"><span class="icon-th-list"></span> Bisnis</h5>
							<div class="content">
								<div class="isi-berita">
									<img class="img-polaroid" src="img/imagesite/post/p1.png" />
									<h6 class="judul-terbaru"><a href="">Kompleks Suko Berdarah ! Gegeran Harga Ceker Kitip, Nyawa Tercabut</a></h5>
							...
							<script src="js/widget.js"></script>
								<script src="js/memotweet.js"></script>
					...
					<div class="span12">
						<section class="footer-body">
							<nav class="footer-nav">
								<ul class="nav-catagories">
									<li><a href="#">Beranda</a></li>
									<li><a href="#">Redaksi</a></li>
									<li><a href="#">Ketentuan Layanan</a></li>
									<li><a href="#">Mash Up</a></li>
									<li><a href="#">Harga Iklan</a></li>
						...
						<div class="row-fluid">
							<div class="span2">
								<div class="branding">
									<a href="#"><img class="perjuangan-logo" src="img/imagesite/logo.png"></a>
								</div>
							</div>
							<div class="span10">
								<section class="footer-link">
									<ul class="adtl-links">
										<li>© 2012 Perjuangan. All rights reserved </li>&nbsp;
										<li><a href="#">Privacy Policy</a></li>
										<li><a href="#">RSS</a></li>
										<li><a href="#">Newsletter</a></li>
										<li><a href="#">Mobile</a></li>
									</ul>
									<ul class="adtl-links2">
		...
		<div class="scrollTo_top" style="display: block; ">
			<a title="Scroll To Top" href="#">
				<img src="img/imagesite/gotop.png" alt="Ke Atas">
			</a>
		</div>
	...
	$(function()
	{
		...
		{
			setTimeout(function(){
				$('#tickerz li:first').animate( {marginTop: '-120px'}, 800, function()
				{
					$(this).detach().appendTo('ul#tickerz').removeAttr('style');	
				});
				ticker();
			}, 4000);
		};
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {
			...
			jQuery('#newsslider').accessNews({
				...
				subtitle:"Dari redaksi untuk Anda"
			});
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			width: 286, // width of slider panel
