								...
								<form>
									<div class="span4">
										...
										<div class="control-group">
											<label class="control-label" for="inputKategori">Nama Album</label>
											<div class="controls">
											<input type="text" id="inputKategori" placeholder="Kategori" name="judul_kategori">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="inputSlug">Slug</label>
											<div class="controls">
											<input type="password" id="inputSlug" placeholder="Slug">
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
