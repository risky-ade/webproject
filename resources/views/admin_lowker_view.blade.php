...
@section('container')
		<div class="container-fluid contenadmin">
			<div class="row-fluid">
				...
				<div class="span9">
					<div class="konten">
							<h4>Lowongan Kerja <a href=""><span class="label label-important">Tambah</span></a></h4>
							<hr />
							<div class="row-fluid">
							<div class="span12">
								...
								<div class="span12">
									<table class="table table-hover">
										...
										<tbody>
											<tr>
												<td><input type="checkbox" name="radio" value="pilihsemua" /></td>
												<td><a href="">Pekerjaan</a></td>
												<td>Editor</td>
												<td>PT. Maju Jaya</td>
												<td><a href="">email@kantor.org</a></td>
												<td><a href=""><img src="img/imagesite/admin/lowker.jpg" width="75" height="150" /></a></td>
