...
@section('container')
		...
		<div class="container-fluid contenadmin">
			<div class="row-fluid">
				...
				<div class="span9">
					<div class="konten">
							<h4>Foto <a href=""><span class="label label-important">Tambah</span></a></h4>
							<hr />
							<div class="row-fluid">
							<div class="span12">
								...
								<div class="span12">
									<table class="table table-hover">
										...
										<tbody>
											<tr>
												<td><input type="checkbox" name="radio" value="pilihsemua" /></td>
												<td><a href="">Foto 1</a></td>
												<td><a href=""><img src="img/imagesite/admin/foto.jpg" width="100" height="100" /></a></td>
												<td><a href="">Perampokan</a></td>
